...
$ S_1 = 2 \sqrt{2} \cos(\arccos(\frac{\sqrt{2}}{4})) = 2 \sqrt{2} \frac{\sqrt{2}}{4} = 1$. For computing $S_2$ we use the following trigonometric formula: 
$\cos(2x)=2\cos(x)^2 - 1$. We have that: $ S_2 = 2 \sqrt{4} \cos(2 \arccos(\frac{\sqrt{2}}{4})) = 4 (2 \cos(\arccos(\frac{\sqrt{2}}{4})) - 1) = 4 (2 / 8 - 1) = -3$ so both $S_1$ and $S_2$ are odd number. 
Since , we can think of finding a recurrence relation involving $ S_n $ terms.
